                ...
                <div className='flex gap-10 mt-5'>
                    <aside className='h-fit'>
                        {sideBar.map((el, i) => (
                            <div 
                                key={i}
                                onClick={() => setSearchParams({ section: el.textEn })}
                                className={`
                                    ${activeTab === el.textEn ? 'bg-[#ce8a3e] text-white' : `${theme === 'light' ? 'hover:bg-[#f5f3f1] hover:text-black' : 'hover:bg-[#241f1d] hover:text-white'}`}
