    ...
    return (
        <div>
            <div className='flex justify-between items-center mt-5'>
                <h3 className={`${theme === 'light' ? 'text-black' : 'text-white'} font text-xl`}>{lang === 'en' ? 'Saved Addresses' : 'შენახული მისამართები'}</h3>
                <button 
                    ...
                    `}
                    >
                        <FaPlus /> {lang === 'en' ? 'Add Address' : 'მისამართის დამატება'}
                </button>
            </div>
